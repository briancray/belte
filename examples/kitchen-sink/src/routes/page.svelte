...
<section class="mt-6 rounded-lg border border-slate-200 bg-white p-5">
    ...
    <p class="mt-1 text-sm text-slate-600">
        <code class="font-mono">routes/time/endpoint.ts</code>
        exports a <code class="font-mono">GET</code> remote function. On the client it's a typed proxy —
...
<section class="mt-6 rounded-lg border border-slate-200 bg-white p-5">
    ...
    <p class="mt-1 text-sm text-slate-600">
        Cookie-based session. <code class="font-mono">routes/session/endpoint.ts</code>
...
<section class="mt-6 rounded-lg border border-slate-200 bg-white p-5">
    ...
    <p class="mt-1 text-sm text-slate-600">
        <code class="font-mono">routes/counter-state/endpoint.ts</code>
        exports <code class="font-mono">getCounter</code>, <code class="font-mono">incrementCounter</code>,
        and <code class="font-mono">resetCounter</code>. Reading
