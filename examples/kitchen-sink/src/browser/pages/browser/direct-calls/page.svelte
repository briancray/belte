...
<section class="mt-6">
    ...
    <p class="mt-2 text-xs text-slate-500">
        Non-2xx throws <code class="font-mono">HttpError</code>. Need the raw response or to stream?
        See <a class="underline" href="/server/raw-stream"> .raw and .stream(args?) </a>.
    </p>
</section>
...
<section class="mt-6 rounded-lg border border-slate-200 bg-white p-5">
    ...
    <p class="mt-1 text-xs text-slate-500">
        ...
        and <code class="font-mono">.method</code> make forms first-class — no JS required.
    </p>
    <form
