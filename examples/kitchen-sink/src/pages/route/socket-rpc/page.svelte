...
<p class="mt-2 text-slate-600">
    ...
    — every SOCKET rpc rides on it, with the route URL acting as the channel.
</p>

<section class="mt-6 rounded-lg border border-slate-200 bg-white p-5">
    <h2 class="text-sm font-semibold">Declaration — <code class="font-mono">src/route/chatFeed.ts</code></h2>
