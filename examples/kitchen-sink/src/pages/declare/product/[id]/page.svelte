...
<div class="mt-6 flex flex-wrap gap-2 text-sm">
    {#each ['1', '2', '3'] as candidate (candidate)}
        <button
            ...
            onclick={() => navigate(`/declare/product/${candidate}`)}>
            navigate to /declare/product/{candidate}
        </button>
    {/each}
</div>

<p class="mt-6 text-sm text-slate-500">
    Source: <code class="font-mono">src/pages/declare/product/[id]/page.svelte</code>
</p>
