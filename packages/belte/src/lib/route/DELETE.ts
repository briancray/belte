...
/*
Defines a DELETE endpoint inside an endpoint.ts file. The bundler plugin
...
*/
export function DELETE<Args = undefined, Return = unknown>(
    _handler: RemoteHandler<Args, Return>,
    _options?: RemoteOptions,
): RemoteFunction<Args, Return> {
    throw new Error(
        '[belte] `DELETE` was called outside an endpoint.ts module — verb helpers are only valid inside src/routes/**/endpoint.ts',
    )
}
