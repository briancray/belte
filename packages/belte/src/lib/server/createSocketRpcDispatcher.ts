...
/*
Bridges the framework's socket-rpc URL space to a single ws connection
...
*/
export function createSocketRpcDispatcher(rpc: SocketRoutes): SocketRpcDispatcher {
