...
Add `@belte/inspector` — an opt-in inspector activated by `BELTE_ENABLE_INSPECTOR=true`. Install it (`bun add -d @belte/inspector`) and the flag mounts a UI at `/__belte/inspector`.
